...
```{r}
pd <- predict(birthwt.lm, birthwt[20,], level = 0.99)
pd
```
Actual
```{r}
...
## Predict New Data
```{r}
testdata = list(mother.age=20, mother.smokes="yes")
pd <- predict(birthwt.lm, testdata, level = 0.99)
pd
```

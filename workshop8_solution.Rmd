...
## at confident level = 70%
```{r}
mpg.t.test <- t.test(MPG.highway ~ Origin, data = Cars93, conf.level = 0.70)
mpg.t.test
```
...
The p-value from the t-test is somewhat smaller than that output by wilcox.test. 
